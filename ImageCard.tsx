...
const ImageCard: React.FC<ImageCardProps> = ({
    ...
    return (
        <div className="group flex flex-col">
            ...
            <div className={`relative w-full flex justify-center items-center rounded-2xl overflow-hidden shadow-xl bg-gradient-to-br from-gray-100 to-gray-200 border-2 border-gray-200 group-hover:border-indigo-300 transition-all duration-300 ${imageContainerClassName}`}>
                {isRegenerating && (
